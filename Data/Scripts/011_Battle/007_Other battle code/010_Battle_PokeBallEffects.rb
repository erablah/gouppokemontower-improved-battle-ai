...
#===============================================================================
# Global Catch Rate Modifier (All Balls +1.5x)
#===============================================================================
Battle::PokeBallEffects::ModifyCatchRate.add(:_GLOBAL_CATCH_BONUS, proc { |ball, catchRate, battle, battler|
  catchRate *= 1.2   # 전역 1.5배
  next catchRate
})
