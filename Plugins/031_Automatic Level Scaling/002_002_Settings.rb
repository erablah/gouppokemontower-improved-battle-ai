...
module LevelScalingSettings
  ...
  DIFFICULTIES = {
    1 => Difficulty.new(fixed_increase: -7, random_increase: 1),
	2 => Difficulty.new(fixed_increase: -5, random_increase: 1),
    3 => Difficulty.new(fixed_increase: -3, random_increase: 1),
    4 => Difficulty.new(fixed_increase: -2, random_increase: 1),  
